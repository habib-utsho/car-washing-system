...
exports.myBookingRouter = router2;
...
router2.get('/my-bookings', (0, auth_1.default)(user_constant_1.USER_ROLE.user), booking_controller_1.bookingControllers.getMyBookings); //TODO: only accessible by user
