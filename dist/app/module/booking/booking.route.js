...
router.get('/', (0, auth_1.default)(user_constant_1.USER_ROLE.admin, user_constant_1.USER_ROLE.user), booking_controller_1.bookingControllers.getAllBookings); //TODO: only accessible by admin
