...
const initPayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const paymentInfo = Object.assign({ store_id: 'aamarpaytest', success_url: 'http://www.merchantdomain.com/successpage.html', fail_url: 'http://www.merchantdomain.com/failedpage.html', cancel_url: 'http://www.merchantdomain.com/cancelpage.html', currency: 'BDT', signature_key: 'dbb74894e82415a2f7ff0ec3a97e4183', desc: 'Merchant Registration Payment', cus_city: 'Dhaka', cus_state: 'Dhaka', cus_postcode: '1206', cus_country: 'Bangladesh', type: 'json' }, payload);
